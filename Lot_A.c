...
/*----------------------------------------------------------------------------------*/
/* @requires : p un plateau correspondant au plateau de jeu et t un autre plateau qui correspond un tableau tache vide (t[i][j]==1 si ce point appartient a la tache et 0 sinon). ATTENTION, la tache doit être vide.
